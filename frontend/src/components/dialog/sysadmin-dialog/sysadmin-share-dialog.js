...
class SysAdminShareDialog extends React.Component {
  ...
  renderDirContent = () => {
    ...
    const {enableDirPrivateShare} = this.props;
    return (
      <Fragment>
            ...
            {enableDirPrivateShare &&
              <Fragment>
                <TabPane tabId="shareToUser">
                  <SysAdminShareToUser itemType={'library'} isGroupOwnedRepo={false} itemPath={this.props.itemPath} repoID={this.props.repoID} isRepoOwner={this.state.isRepoOwner}/>
                </TabPane>
                <TabPane tabId="shareToGroup">
                  <SysAdminShareToGroup itemType={'library'} isGroupOwnedRepo={false} itemPath={this.props.itemPath} repoID={this.props.repoID} isRepoOwner={this.state.isRepoOwner}/>
                </TabPane>
              </Fragment>
            }
          </TabContent>
