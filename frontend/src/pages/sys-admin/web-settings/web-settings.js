...
class WebSettings extends Component {
  ...
  saveSetting = (key, value) => {
    seafileAPI.sysAdminSetSysSettingInfo(key, value).then((res) => {
      this.setState(prevState => {
        let config_dict = Object.assign({}, prevState.config_dict);
  ...
  postFile = (file, fileType) => {
    ...
    if (fileType == 'Logo') {
      ...
      postFile = seafileAPI.updateFaviconAdmin(file);
    ...
    postFile.then((res) => {
      if (fileType == 'Logo') {
        this.setState({
          logoPath: res.data.custom_logo_path
        });
      } else if (fileType == 'Favicon') {
        this.setState({
          faviconPath: res.data.custom_favicon_path
        });
      } else if (fileType == 'loginBGImage') {
        this.setState({
          loginBGPath: res.data.custom_login_bg_image_path
        });
      }
      this.forceUpdate();
      toaster.success(gettext('Success'));
    ...
    // if (fileType == 'Logo') {
    //   seafileAPI.sysAdminUpdateLogo(file).then((res) => {
    //     if (this.state.logoPath == res.data.custom_logo_path) {
    //       this.forceUpdate();
    //     } else {
    //       this.setState({
    //         logoPath: res.data.custom_logo_path
    ...
    //   });    
    // } else if (fileType == 'Favicon') {
    //   seafileAPI.updateFaviconAdmin(file).then((res) => {
    //     if (this.state.faviconPath == res.data.custom_favicon_path) {
    //       this.forceUpdate();
    //     } else {
    //       this.setState({
    //         faviconPath: res.data.custom_favicon_path
    ...
    //   });
    // } else if (fileType == 'loginBGImage') {
    //   seafileAPI.sysAdminUpdateLoginBG(file).then((res) => {
    //     if (this.state.loginBGPath == res.data.custom_login_bg_image_path) {
    //       this.forceUpdate();
    //     } else {
    //       this.setState({
    //         loginBGPath: res.data.custom_login_bg_image_path
