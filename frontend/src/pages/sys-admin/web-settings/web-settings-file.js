      ...
      <Fragment>
        <Row>
          ...
          <Col xs="4">
            ...
            <img src={mediaUrl + filePath + '?t=' + new Date().getTime()} alt="" width={fileWidth} height={fileHeight}/>
            <p>{helpTip}</p>
          </Col>
          <Col xs="4">
            <Button className="btn btn-outline-primary" color="success" onClick={this.openFileInput}>{gettext('Change')}</Button>
