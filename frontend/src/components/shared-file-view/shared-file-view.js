...
const { repoID, sharedToken, trafficOverLimit, fileName, fileSize, sharedBy, siteName, enableWatermark, download, zipped, filePath, enableShareLinkReportIllegal } = window.shared.pageOptions;
